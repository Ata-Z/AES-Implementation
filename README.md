# AES-Implementation
I made the Advanced Encryption Standard in C++, while the code itself is mine, the ideas of it are obviously based off the pre existing standard, the **main** reason I did this was to learn the math behind the cryptography rather than the code, and how math really gets applied to computer science, learnt/used concepts such as finite field theory and linear algebra, as well as working with matrices.
